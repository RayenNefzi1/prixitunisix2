"""
Zoom Informatique spider — scrapes product listings from zoom.com.tn
"""
import re
import unicodedata
...
ZOOM_WEBSITE_ID = 4  # Will need to match merchant_websites.id
...
class ZoomSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for link in links:
            if "zoom.com.tn/" in link and re.search(r"/\d+-[a-zA-Z0-9-]+$", link):
    ...
    def parse_category(self, response):
        ...
        self.logger.info(f"[zoom] {len(articles)} products on {response.url}")
    ...
    def parse_product(self, response):
        ...
        yield OfferItem(
            ...
            merchant_website_id=ZOOM_WEBSITE_ID,
